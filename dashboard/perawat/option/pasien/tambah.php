...
if (isset($_POST['submit'])) {
    ...
    $sql = mysqli_query($koneksi, "INSERT INTO t_pasien (nama, id_temp, umur, alamat, kelamin, suhu, tgl_karantina, tgl_selesai_karantina, tgl_cek, id_petugas) 
    VALUES ('$nama','$id_temp','$umur','$alamat','$kelamin','$suhu','$tgl_karantina','$tgl_selesai','$tgl_karantina', '" . $petugas['id_petugas'] . "')");
    if ($sql) {
