            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-5 col-sm-12">
                        <img src="images/main.svg" alt="Lets Check">
                    </div>
                </div>
            </div>
        </header>
            ...
            <section class="tips" id="tips">
                ...
                <div class="container-fluid text-center">
                    <div class="numbers d-flex flex-md-row flex-wrap justify-content-center">
                        ...
                        <div class="rect">
                            <div class="col-sm-12">
                                <img src="images/tissue.svg" alt="SapuTangan" class="tipss">
                        ...
                        <div class="rect">
                            <div class="col-sm-12">
                                <img src="images/mask.svg" alt="masker" class="tipss">
                        ...
                        <div class="rect">
                            <div class="col-sm-12">
                                <img src="images/animal.svg" alt="hewan" class="tipss">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-5 col-sm-12 text-left">
                            ...
                            <p>
                                Nama Lengkap: Ahmadun Na'il
                                <br>
                                Jenis Kelamin: Laki-Laki
                                <br>
                                Tempat, Tanggal Lahir: Kediri, 06 Juli 2004
                                <br>
                                Alamat: Jl. Imam Bonjol, Tembarak, Kertosono, Nganjuk
                                <br>
                                Agama: Islam
                                <br>
                                Suku: Jawa
            ...
            <div class="container-fluid">
                <div class="row text-left">
                    <div class="col-md-5 col-sm-5">
                        ...
                        <a href="https://www.instagram.com/naelsss/?hl=id"><i class="fab fa-instagram"></i></a>
    ...
    <div id="pasien" class="modal fade" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="logic/masukdata.php" method="post">
