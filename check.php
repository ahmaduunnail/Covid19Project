...
<body>
    <div class="container-fluid text-center">
        <div class="row">
            <div class="col-md-12">
                <h2>KLik Dibawah untuk melanjutkan</h2>
                <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#Satu" data-title="hi" name="submit">Selanjutnya</button>
            </div>
        </div>
    </div>
    <section id="takok">
        <div id="Satu" class="modal fade" tabindex="-1" id="myModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="logic/positif.php" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-default" name="positif">Ya</button>
